...
$(document).ready(function(){
	...
	$( 'div' ).on( 'click', '.global-nav .main-nav .lst-main-nav li > a.dropnav, .global-nav .main-nav .lst-main-nav li:first-child a', function (e) {	
		...
		else if($(this).hasClass('transaction')){ 			
			$(this).closest('.lst-main-nav').find('a.dropnav').removeClass('mn-open');
			$(this).closest('.lst-main-nav').find('div.sub-nav').removeClass('sn-open');
			$(this).closest('.lst-main-nav').find('div.sub-nav').find('ul.lst-sub-nav li a.s-dropnav').removeClass('smn-open');
			$(this).closest('.lst-main-nav').find('div.sub-nav .lst-sub-nav li div.super-sub-nav').removeClass('ssn-open');
...
/* -- Edit form field */
	...
	$('button.edit1').on('click', function() { 
		$('button.showbtn').css("display", "block");
	    $('button.edit1').css("display", "none");  
   // alert();
		if ( !$( '.ux-component input' ).parent('.ux-component').has( '.ux-readonly' ) ) {
			// $('.ux-component input.atmid').parent('.ux-component').addClass('ux-readonly');
			// $('.ux-component input.atmid').attr('disabled','disabled');
			  ...
			  $('.ux-component a.calendar.disabled').addClass('disabled');
			  $('input #atm').attr('disabled','disabled'); 
		   //   $('button.showbtn').css("display", "none"); 
		  }
		  else if (!$( '.ux-component input' ).parent('.ux-component').has( '.ux-disabled1' )) {
			//  block of code to be executed if the condition1 is false and condition2 is true
			$('.ux-component input.atm').parent('.ux-component').addClass('ux-readonly');
			$('.ux-component input.atm').parent('.ux-component').addClass('ux-disabled');
			$('.ux-component input.atm').attr('disabled','disabled');
		  }
			...
			$('.ux-component a.calendar.disabled').removeClass('disabled');
			$('.ux-component input.atm').parent('.ux-component').addClass('ux-readonly');
			$('.ux-component input.atm').parent('.ux-component').addClass('ux-disabled');
			$('.ux-component input.atm').attr('disabled','disabled');
		 }
